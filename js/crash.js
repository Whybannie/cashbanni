// ===== CRASH v3: незамерзающий, история ТОЛЬКО сверху =====
var CR2 = { ROUND:15000, BET:6000, SEED:'cashbanni_v1' };
if (typeof crash === 'undefined') var crash = {};
crash.phase=crash.phase||'bet'; crash.m=1; crash.cp=1; crash.myBet=0; crash.cashed=false;
crash.hist=crash.hist||[]; crash.lastInt=1; crash.sparks=[]; crash.betVal=crash.betVal||20;
crash.auto=crash.auto||0; crash.lastFrame=Date.now();
